...
module.exports = Vue;
},{}],"Ahjv":[function(require,module,exports) {
"use strict";
...
},{"vue":"ApMz"}],"kLUt":[function(require,module,exports) {
!function (i) {
  var t,
...
},{"./svg.js":"kLUt"}],"8HX7":[function(require,module,exports) {
"use strict";
...
},{"./icon":"Bqhn"}],"TELE":[function(require,module,exports) {
"use strict";
...
describe('CollapseItem', function () {
  ...
  it('接受 name', function () {
    var Constructor = _vue.default.extend(_collapseItem.default);
    ...
    var element = vm.$el.querySelector('.title');
    expect(element.getAttribute('data-name')).to.be.eq('22');
  });
  it('接受 title', function () {
    var Constructor = _vue.default.extend(_collapseItem.default);
  ...
  it('接受 arrow', function () {
    ...
    var element = vm.$el.querySelector('.g-icon');
    expect(element).to.not.exist;
  });
});
},{"vue":"ApMz","../src/collapse":"Ahjv","../src/collapse-item":"8HX7","../src/icon":"Bqhn"}]},{},["TELE"], null)
//# sourceMappingURL=/collapse-item.test.map