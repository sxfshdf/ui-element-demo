...
exports.default = _default;
      ...
      if (typeof $5caeb8 === 'function') {
        ...
        Object.assign($5caeb8, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('button',{staticClass:"g-button",class:( _obj = { 'g-button-animate': !_vm.disabled, 'g-button-loading': _vm.loading}, _obj[("icon-" + _vm.iconPosition)] = true, _obj[("g-button-" + _vm.type)] = (_vm.type? true: false), _obj[("g-button-" + _vm.shape)] = (_vm.shape ? true:false), _obj ),attrs:{"disabled":_vm.disabled},on:{"click":function($event){_vm.$emit('click',$event)}}},[(_vm.icon && !_vm.loading)?_c('g-icon',{staticClass:"icon",attrs:{"name":_vm.icon}}):_vm._e(),_vm._v(" "),(_vm.loading)?_c('g-icon',{staticClass:"loading icon",attrs:{"name":"loading"}}):_vm._e(),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.isShow),expression:"isShow"}],staticClass:"content",class:{'left':(_vm.iconPosition==='right'), 'right':(_vm.iconPosition==='left'&&_vm.icon)}},[_vm._t("default")],2)],1)
var _obj;}
var staticRenderFns = []
